...
@section('dashboard-title','Contact')
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs mb-2"><span class="mr-2"><a  href="{{ url('/') }}">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Contact us <i class="ion-ios-arrow-forward"></i></span></p>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-3">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Email:</span> <a href="mailto:info@yoursite.com">unicare@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="dbox w-100 text-center">
                                ...
                                <div class="text">
                                    <p><span>Website</span> <a href="#">Unicare.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  <form method="POST" id="contactForm" name="contactForm" class="contactForm"  action="{{  route('contact.submit')  }}">
    {{ csrf_field() }}
                        ...
                        <div class="col-md-5 d-flex align-items-stretch">
                            <div class="info-wrap w-100 p-5 img" style="background-image: url('{{ asset('assets/images/about-3.jpg')  }}');">
                            </div>
                        </div>
                    </div>
                </div>
